  ...
  useEffect(() => {
    ...
    stream.onerror = () => {
      ...
      fallbackTimer = window.setInterval(async () => {
        ...
        } catch (_) { /* EventSource will continue reconnecting. */ }
      }, 3000);
    };
    return () => {
      stream.close();
